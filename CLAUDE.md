...
### フェーズ3 — 詳細は `docs/through-my-space-spec.md` を参照

**実装予定（新規症状の追加）**
- [ ] 夜盲症、コントラスト感度低下、羞明、スターガルト病、糖尿病性網膜症
- [ ] 高度近視、半盲・四分盲、角膜ジストロフィー
...
- [ ] 症状選択UIのグリッド化（HStack → LazyVGrid、症状数増加に対応）
- [ ] SpatialPhotoError のエラーメッセージローカライズ

**見送り（バックログ）**
- [ ] 症状の重ねがけモード、当事者の声、症状プリセット、サンプル空間写真バンドル
- [ ] 写真履歴、オンボーディング、パネルリポジション
- [ ] アクセシビリティ対応、体験共有、匿名利用統計
...
| 難易度 | 症状 | 方式 | 流用元 | 工数 |
|---|---|---|---|---|
| 🟢 | 夜盲症 | CIフィルター | 老眼フィルター | 極小 |
| 🟢 | コントラスト感度低下 | CIフィルター | 老眼フィルター | 極小 |
| 🟢 | 羞明（光過敏） | CIフィルター | 白内障フィルター | 小 |
| 🟢 | スターガルト病 | Entity オーバーレイ | 中心暗点 Entity | 小 |
| 🟢 | 糖尿病性網膜症 | Entity(+CI) | 飛蚊症 Entity | 小〜中 |
| 🟡 | 高度近視 | CIフィルター | 網膜色素変性症 CI版 | 中 |
| 🟡 | 半盲・四分盲 | Entity オーバーレイ | 視野狭窄 Entity | 中 |
| 🟡 | 角膜ジストロフィー | CIフィルター | 白内障フィルター | 中 |
| 🔴 | 眼振 | — | — | 見送り（VR酔い） |
| 🔴 | 複視 | — | — | 見送り（立体視と競合） |
| 🔴 | レーバー先天性黒内障 | — | — | 見送り（コンセプト不適合） |
